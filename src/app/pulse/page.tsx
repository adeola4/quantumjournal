...
const INITIAL_PRINCIPLES: Principle[] = [
  {
    ...
    towardQuestions: [
      ...
      "Am I building bone, or am I fracturing it?",
    ],
    dissolveQuestions: [
      "What do I want to stop being integrated to?",
      "What word have I given — to myself or another — that I am still avoiding?",
      "Where is my word cracking under pressure?",
    ],
    towardAnswers: ["", "", ""],
    dissolveAnswers: ["", "", ""],
    completedAt: null,
  },
  {
    ...
    towardQuestions: [
      "What would I say if no one could judge me?",
      "Where am I bending myself to be approved?",
      "What truth am I afraid to speak — even to myself?",
    ],
    dissolveQuestions: [
  ...
  },
  {
    ...
    towardQuestions: [
      "Am I choosing, or am I reacting?",
    ...
    dissolveQuestions: [
      ...
      "Where am I pointing away from my own power?",
    ],
    towardAnswers: ["", "", ""],
    dissolveAnswers: ["", "", ""],
    completedAt: null,
  },
  {
    ...
    towardQuestions: [
      "Who did I enrich today — and who did I deplete?",
      "Am I a source, or a leak?",
      "What am I ready to give without needing to be seen?",
    ],
    dissolveQuestions: [
      "What am I hoarding that is meant to flow?",
      "Did I uplift, or did I leak — gossip, consume, drain?",
      "Where did I take when I could have given?",
    ],
    towardAnswers: ["", "", ""],
    dissolveAnswers: ["", "", ""],
    completedAt: null,
  },
  {
    ...
    towardQuestions: [
      "What reality am I creating right now — consciously or not?",
      "What do I choose to cause into existence this week?",
      "What new pattern am I ready to birth?",
    ],
    dissolveQuestions: [
      "What did I cause today that I am pretending happened *to* me?",
      "Am I the cause, or the effect?",
      "What am I unconsciously causing through my repeating pattern?",
    ],
    towardAnswers: ["", "", ""],
    dissolveAnswers: ["", "", ""],
    completedAt: null,
